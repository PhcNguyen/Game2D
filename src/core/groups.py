...
from src.core.sprites import Sprite, Cloud



# Lớp WorldSprites kế thừa từ pygame.sprite.Group, đại diện cho nhóm các sprite trong thế giới trò chơi
class WorldSprites(pygame.sprite.Group):
    ...
    # Phương thức vẽ các sprite lên màn hình
...
# Lớp AllSprites kế thừa từ pygame.sprite.Group, đại diện cho tất cả các sprite trong trò chơi
class AllSprites(pygame.sprite.Group):
    def __init__(self, width, height, clouds, horizon_line, bg_tile=None, top_limit=0):
        ...
        else:  # Nếu không có bg_tile, tạo bầu trời
    ...
    # Ràng buộc camera trong giới hạn
